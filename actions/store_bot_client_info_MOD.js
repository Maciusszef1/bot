module.exports = {
	...
	<div style="float: left; width: 80%; padding-top: 8px;">
		...
		<select id="info" class="round">
			<optgroup label="Czas pracy bez przestojów">
				<option value="23">Czas pracy bota w dniach</option>
				<option value="24">Czas pracy bota w godzinach</option>
				<option value="25">Czas pracy bota w minutach</option>
				<option value="26">Czas pracy bota w sekundach</option>
			</optgroup>
			<optgroup label="Wartości">
				<option value="3">Lączna liczba serwerów</option>
				<option value="4">Łączna liczba użytkowników</option>
				<option value="10">Łączna liczba kanałów</option>
				<option value="11">Całkowita ilość emotikonów</option>
        <option value="32">Łączna liczba komend</option>
        <option value="33">Lączna liczba eventów</option>
				<option value="9">Całkowita liczba połączeń głosowych</option>
      </optgroup>
      <optgroup label="Tablice serwerów">
				<option value="16">Obiekty Bot serwerów</option>
				<option value="17">Nazwy serwerów bota</option>
				<option value="18">Serwery bota pod id</option>
			<optgroup label="Bot Informacje">
				<option value="19">Bieżący prefix bota</option>
				<option value="20">Id bota</option>
				<option value="44">ID właściciela bota</option>
				<option value="28">System operacyjny bota</option>
				<option value="30">Bot Directory</option>
				<option value="8">Token bota (bądź ostrożny)</option>
			</optgroup>
			<optgroup label="Pomiary systemowe">
				<option value="29">Użycie UPU (MB)</option>			
				...
				<option value="41">Używana pamięć (GB)</option>
				<option value="42">Używana pamięć (MB)</option>
				<option value="43">Używana pamięć (%)</option>
			</optgroup>
			<optgroup label="Pomiary botów">
				<option value="27">Użycie pamięci (RAM) w MB</option>
				<option value="1">Dostępny od (Data)</option>
				<option value="34">Dostępny od [sygnatura czasowa unix]</option>
				<option value="2">Ping Bota</option>
				<option value="5">Ping zaokrąglone</option>
				<option value="12">Bot Poprzednie Pingi</option>
			</optgroup>
			<optgroup label="Wersje">
				<option value="21">Wersja Discord JS</option>
				<option value="31">Wesja Node js</option>
			</optgroup>
		</select>
	</div><br><br><br>
	<div>
